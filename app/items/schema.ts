...
export const items = pgTable('items', {
  ...
  // Human readable item name (short). Required.
  ...
  // Purchase (acquisition) price (stored as numeric(10,2)). Defaults to 0.00
  purchasePrice: numeric('purchase_price', { precision: 10, scale: 2 }).notNull().default('0'),
  // Rental price (stored as numeric(10,2)). Defaults to 0.00
  rentPrice: numeric('rent_price', { precision: 10, scale: 2 }).notNull().default('0'),
